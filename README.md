...
|-----------------|---|---|---|----|----|----|----|------------------|
| $\left[0, 10^{9}\right[$ | 0.427 | 0.111 | 0.057 | 0.032 | 0.022 | 0.020 | 0.021 | 50847534 |
| $\left[0, 2^{32}-1\right[$ | 1.951 | 0.507 | 0.255 | 0.130 | 0.071 | 0.057 | 0.053 | 203280221 |
| $\left[10^{12}, 10^{12}+10^{10}\right[$ | 7.031 | 1.765 | 0.888 | 0.446 | 0.231 | 0.167 | 0.174 | 361840208 |
| $\left[10^{15}, 10^{15}+10^{10}\right[$ | 32.034 | 8.058 | 4.035 | 2.027 | 1.047 | 0.730 | 0.651 | 289531946 |
| $\left[10^{18}, 10^{18}+10^{10}\right[$ | 617.296 | 155.100 | 77.396 | 38.867 | 20.141 | 14.028 | 12.003 | 241272176 |
| $\left[2^{64}-10^{10}, 2^{64}-1\right[$ | 2452.285 | 644.818 | 322.765 | 160.173 | 83.896 | 58.793 | 49.332 | 225402976 |


These timings were measured on an AMD EPYC 9R14.
